 ...
 * @author Gilmar
 */
public class PesquisarUsuarioButtonHandlerFrequencia implements ActionListener{
    
    ProcurarUsuarioFrequencia procurarUsuario;

    public PesquisarUsuarioButtonHandlerFrequencia(ProcurarUsuarioFrequencia procurarUsuario) {
...
//        funcionarios[1] = new Funcionario();
        ...
        try {
            ...
            Logger.getLogger(PesquisarUsuarioButtonHandlerFrequencia.class.getName()).log(Level.SEVERE, null, ex);
        }
